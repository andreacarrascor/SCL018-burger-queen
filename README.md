...
[React](https://es.reactjs.org/) es una de las _librerías_ de JavaScript más utilizadas por
...
@@ -90,649 +66,32 @@ con todos sus _productos_. El usuario debe poder ir eligiendo qué _productos_
